...
const IOTEVChargingPage = () => {
  return (
    <div>
      ...
      <div className="w-full bg-sky-900 py-10 mt-10">
        <div className="max-w-6xl mx-auto text-center space-y-6 px-6">
          <h1 className="text-4xl md:text-5xl font-bold text-white">
            Looking for a Smart IoT or EV Charging Solution?
          </h1>
      ...
      <div className="grid grid-cols-2 gap-7">
  {/* IOT Project Link */}
  <Link href="/portfolio/food-court-app" className="block">
    <div className="shadow-md hover:shadow-lg transition rounded-lg overflow-hidden cursor-pointer">
      <img
        src={Foodcourt_App.src}
        alt="IOT EV Charging Platform Screenshot"
        className="w-full h-80 object-cover hover:scale-105 transition-transform duration-300"
      />
      <h3 className="text-center text-lg font-semibold text-gray-800 py-3">
        IOT EV Charging Platform
      </h3>
    </div>
  </Link>

  {/* Foodcourt Admin Project Link */}
  <Link href="/portfolio/foodcourt-admin" className="block">
    <div className="shadow-md hover:shadow-lg transition rounded-lg overflow-hidden cursor-pointer">
      <img
        src={Foodcourt_Admin.src}
        alt="Foodcourt Admin Screenshot"
        className="w-full h-80 object-cover hover:scale-105 transition-transform duration-300"
      />
      <h3 className="text-center text-lg font-semibold text-gray-800 py-3">
        Foodcourt Admin
