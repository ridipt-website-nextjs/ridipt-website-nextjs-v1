    ...
    <div className="bg-background text-foreground">
      ...
      <div className="relative p-10">
        ...
        <div className="relative max-w-6xl mx-auto space-y-12 z-10">
          {/* Main Card */}
          <div className="bg-card shadow-lg p-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center border border-border">
            <div>
              <img
                src={IOTImg.src}
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-8 mb-8">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-lg">- ChargePoint</p>
                </div>
              </div>

              {/* Technologies */}
              <h2 className="text-3xl font-semibold mb-2 text-card-foreground">Technologies</h2>
              <p className="text-muted-foreground text-lg">- OCPP, MQTT, REST APIs</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative max-w-6xl mx-auto mt-6">
        ...
        <div className="absolute top-0 left-0 w-full h-2/3 bg-sky-100 dark:bg-muted z-0"></div>

        {/* Card content */}
        <div className="relative bg-card shadow-lg p-10 grid grid-cols-1 md:grid-cols-2 gap-12 z-10 border border-border">
          <div>
      ...
      <div className="max-w-6xl mx-auto space-y-12 p-10 mt-1">
        <div className="text-left mt-7">
          ...
          <ul className="list-disc list-inside space-y-3 mt-6 text-muted-foreground text-lg">
            <li>
              <span className="font-bold text-card-foreground">Onboarding:</span> The onboarding process is a critical first impression for users and should be designed to be fast, intuitive, and frictionless. It includes simple account creation through email, phone number, or social login, combined with secure authentication methods like OTP verification or biometric login.
            </li>
            <li>
              <span className="font-bold text-card-foreground">Real-time Feedback:</span> Real-time feedback is essential to build trust and ensure a seamless experience, especially in a system that relies on IoT connectivity. Users should receive instant notifications for key events.
            </li>
            <li>
              <span className="font-bold text-card-foreground">Gamification & Incentives:</span> Real-time feedback is essential to build trust and ensure a seamless experience, especially in a system that relies on IoT connectivity. Users should receive instant notifications for key events, such as charger availability, charging session start, progress updates, completion, or errors like connectivity fai.
            </li>
            <li>
              <span className="font-bold text-card-foreground">Personalization:</span> Real-time feedback is essential to build trust and ensure a seamless experience, especially in a system that relies on IoT connectivity. Users should receive instant notifications for key events, such as charger availability, charging session start, progress updates, completion, or errors like connectivity f.
            </li>
            <li>
              <span className="font-bold text-card-foreground">Offline Support:</span> Real-time feedback is esscompletion, or errors like connectivity failures or device faults. These notifications can be delivered via push messages, in-app alerts, or emails, and should be clear, concise, and actionable.
            </li>
          </ul>
        </div>
        ...
        <div className="text-left mt-12">
          ...
          <div className="grid grid-cols-2 gap-4">
            <img
              ...
              className="w-full h-80 object-cover shadow-md rounded-lg border border-border"
            />
            <img
              src={IOTImg.src}
      ...
      <div className="w-full bg-sky-900 dark:bg-card py-10 mt-10 border-y border-border">
        <div className="max-w-6xl mx-auto text-center space-y-6 px-6">
          ...
          <button className="bg-white dark:bg-primary text-sky-900 dark:text-primary-foreground px-8 py-4 rounded-full font-semibold hover:bg-gray-100 dark:hover:bg-primary/90 transition-all duration-300 shadow-lg">
        ...
        <div className="text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            <div className="text-muted-foreground text-lg leading-relaxed">
              Developing an IoT-based Electric Vehicle (EV) Charging Platform involves creating a fully integrated ecosystem that combines smart hardware, cloud infrastructure, connectivity, and user-facing applications to deliver efficient, reliable, and scalable charging solutions. The development process begins with a thorough requirements analysis, identifying the needs of EV drivers, fleet operators, and utilities while ensuring compliance with safety, cybersecurity, and regulatory standards.
              <br /><br />
        ...
        <div className="text-center mt-12">
          ...
          <div className="grid grid-cols-2 gap-7">
            <img
              src={IOTImg.src}
              alt="IOT EV Charging Platform Screenshot 1"
              className="w-full h-80 object-cover shadow-md rounded-lg border border-border hover:scale-105 transition-transform duration-300"
            />
            <img
              src={IOTImg.src}
              alt="IOT EV Charging Platform Screenshot 2"
      ...
      <div className="max-w-6xl mx-auto text-center space-y-6 px-6 mb-20">
        <button className="bg-background text-sky-900 dark:text-primary dark:bg-card border-2 border-sky-900 dark:border-primary px-7 py-3 rounded-full font-semibold hover:bg-sky-500 hover:text-white dark:hover:bg-primary dark:hover:text-primary-foreground transition-all duration-300 shadow-lg">
          All Projects
        </button>
      </div>
    </div>
