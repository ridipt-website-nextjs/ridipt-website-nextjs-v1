                    ...
                    <div>
                        ...
                        <div className="mt-8">
                            ...
                            <ul className="list-disc list-inside space-y-2 text-muted-foreground text-lg">
                                <li>
                                    <span className="font-bold text-card-foreground">Dashboard:</span> A quick snapshot of business activities and performance.
                                </li>
                                <li>
                                    <span className="font-bold text-card-foreground">Order Management:</span> Handle all orders in one place – pending, accepted, delivered, rejected, and undelivered.
                                </li>
                                <li>
                                    <span className="font-bold text-card-foreground">Subscriptions:</span> Track and manage customer subscriptions efficiently.
                                </li>
                                <li>
                                    <span className="font-bold text-card-foreground">Product Catalog:</span> Access and update product listings for smooth availability.
                                </li>
                                <li>
                                    <span className="font-bold text-card-foreground">Inventory Control:</span> Issue orders and monitor stock in real-time.
                                </li>
                            </ul>
            ...
            <div className="max-w-6xl mx-auto space-y-12 p-10 mt-6">
                <div>
                    ...
                    <ul className="list-disc list-inside space-y-3 text-muted-foreground text-lg">
                        <li>
                            <span className="font-bold text-card-foreground">Simple Dashboard:</span> At-a-glance view of orders, subscriptions, and inventory.
                        </li>
                        <li>
                            <span className="font-bold text-card-foreground">Clear Navigation:</span> Organized menus for orders, products, subscriptions, and stock management.
                        </li>
                        <li>
                            <span className="font-bold text-card-foreground">Mobile-Optimized Design:</span> Seamless experience across smartphones and tablets.
                        </li>
                        <li>
                            <span className="font-bold text-card-foreground">Real-Time Updates:</span> Notifications for order status changes and inventory actions.
                        </li>
                        <li>
                            <span className="font-bold text-card-foreground">Consistency & Accessibility:</span> Uniform design patterns with readable fonts, consistent colors, and user-friendly interactions.
                        </li>
                        <li>
                            <span className="font-bold text-card-foreground">Minimalistic Layout:</span> Focus on essential actions with less clutter for faster decision-making.
                        </li>
                    </ul>
            ...
            <div className="max-w-6xl mx-auto space-y-12 p-10 mt-12">
                <div className="text-left">
                    ...
                    <div className="text-muted-foreground text-lg leading-relaxed space-y-6">
                        ...
                        {/* Mobile App */}
                        <div>
                            <h3 className="text-2xl font-semibold mb-3 text-card-foreground">Mobile App (Frontend)</h3>
                            <ul className="list-disc list-inside space-y-2">
                                <li>
                                    <span className="font-bold text-card-foreground">Flutter:</span> Cross-platform development for Android and iOS with a responsive and clean UI.
                                </li>
                                <li>
                                    <span className="font-bold text-card-foreground">UI/UX Design:</span> Optimized for mobile screens with simple navigation and minimalistic layouts.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside space-y-2">
                                <li>
                                    <span className="font-bold text-card-foreground">Node.js & Express.js:</span> Handles business logic and API services efficiently.
                                </li>
                                <li>
                                    <span className="font-bold text-card-foreground">REST APIs:</span> Enables seamless communication between the app and server.
                                </li>
                                <li>
                                    <span className="font-bold text-card-foreground">Authentication & Security:</span> JWT-based authentication and OTP APIs for secure logins and transactions.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside space-y-2">
                                <li>
                                    <span className="font-bold text-card-foreground">MongoDB:</span> Fast and flexible storage of orders, subscriptions, products, and inventory data.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside space-y-2">
                                <li>
                                    <span className="font-bold text-card-foreground">Microsoft Azure:</span> Reliable cloud hosting ensuring scalability, uptime, and data security.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside space-y-2">
                                <li>
                                    <span className="font-bold text-card-foreground">Manual Testing:</span> Verified all workflows, including orders, subscriptions, and inventory management.
                                </li>
                                <li>
                                    <span className="font-bold text-card-foreground">Automated Testing:</span> Implemented for critical processes to maintain stability and prevent bugs.
                                </li>
                            </ul>
                        </div>
            ...
            <div className="max-w-6xl mx-auto space-y-12 p-10 mt-12">
                <div className="text-center">
                    ...
                    <div className="grid grid-cols-2 gap-7">
                        <img
                            src={SDPImg2.src}
                            alt="Mini Distributor App Screen 1"
                        ...
                        <img
                            src={SDPImg3.src}
                            alt="Mini Distributor App Screen 2"
                            className="w-full h-80 object-contain shadow-md rounded-lg border border-border hover:scale-[1.02] transition-transform duration-300 mt-8"
                        />
                        <img
                            src={SDPImg4.src}
                            alt="Mini Distributor App Screen 3"
                            className="w-full h-80 object-contain shadow-md rounded-lg border border-border hover:scale-[1.02] transition-transform duration-300 mt-8"
                        />
                        <img
                            src={SDPImg5.src}
                            alt="Mini Distributor App Screen 4"
                            className="w-full h-80 object-contain shadow-md rounded-lg border border-border hover:scale-[1.02] transition-transform duration-300 mt-8"
                        />
                        <img
                            src={SDPImg6.src}
                            alt="Mini Distributor App Screen 5"
                            className="w-full h-80 object-contain shadow-md rounded-lg border border-border hover:scale-[1.02] transition-transform duration-300 mt-8"
                        />
                        <img
                            src={SDPImg1.src}
                            alt="Mini Distributor App Screen 6"
                            className="w-full h-80 object-contain shadow-md rounded-lg border border-border hover:scale-[1.02] transition-transform duration-300 mt-8"
                        />
                    </div>
                </div>
