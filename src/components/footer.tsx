          ...
          <div>
            ...
            <div className='space-y-4 mb-6'>
              ...
              <div className='flex items-center space-x-3'>
                ...
                <Link href='mailto:hello@ridipt.com' className='text-muted-foreground hover:dark:text-primary hover:text-secondary transition-colors duration-300 text-sm'>hello@ridipt.com</Link>
              </div>
              <div className='flex items-center space-x-3'>
                <svg className='w-5 h-5 text-blue-400 flex-shrink-0' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
            ...
            <div>
              ...
              <ul className='space-y-2'>
                ...
                <li><Link href='#' className='text-muted-foreground hover:dark:text-primary hover:text-secondary transition-colors duration-300 text-sm'>Blog</Link></li>
              </ul>
            </div>
          </div>
        </div>
