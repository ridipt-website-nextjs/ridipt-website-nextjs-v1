        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12'>
          ...
          <div className='lg:col-span-1'>
            ...
            <div className='flex space-x-4'>
              <Link href='#' className='text-muted-foreground hover:text-primary transition-colors duration-300 p-2 rounded-lg hover:bg-muted/50'>
          ...
          <div>
            ...
            <div className='space-y-4 mb-6'>
              ...
              <div className='flex items-center space-x-3'>
                ...
                <Link href='mailto:hello@ridipt.com' className='text-muted-foreground hover:text-primary transition-colors duration-300 text-sm'>hello@ridipt.com</Link>
              </div>
              <div className='flex items-center space-x-3'>
                <svg className='w-5 h-5 text-blue-400 flex-shrink-0' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z' />
                </svg>
                <Link href='tel:+1234567890' className='text-muted-foreground hover:text-primary transition-colors duration-300 text-sm'>+91 (234) 567-8900</Link>
              </div>
            </div>
        ...
        <div className='border-t border-muted pt-8 mb-8'>
          <div className='max-w-md mx-auto text-center'>
            ...
            <form onSubmit={handleNewsletterSubmit} className='flex gap-2'>
              ...
              <Button
                type='submit'
                className='px-6 py-2 dark:bg-primary bg-accent-foreground  text-primary-foreground hover:bg-primary-foreground hover:text-primary hover:border-border border border-border dark:border-primary   transition-all ease-in-out  text-sm font-medium rounded-lg duration-300 whitespace-nowrap'
              >
                Subscribe
              </Button>
            </form>
        ...
        <div className='container mx-auto px-6 py-4'>
          <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
            ...
            <div className='flex flex-wrap items-center gap-x-6 gap-y-2'>
              <Link href='#' className='text-muted-foreground hover:text-primary transition-colors duration-300 text-sm'>Privacy Policy</Link>
              <Link href='#' className='text-muted-foreground hover:text-primary transition-colors duration-300 text-sm'>Terms of Service</Link>
              <Link href='#' className='text-muted-foreground hover:text-primary transition-colors duration-300 text-sm'>Cookie Policy</Link>
            </div>
          </div>
        </div>
      </div>
