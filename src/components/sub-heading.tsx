...
export function SubHeading({ text, highlightedText, className, customHieghtlightedComponent }: {
    ...
    return (
        <div className={`${className}`}>
            <h1 className="text-4xl md:text-4xl text-inherit lg:text-6xl font-semibold max-w-7xl mx-auto text-center mt-6 relative z-20 py-6 bg-clip-text  bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-white dark:to-white">
